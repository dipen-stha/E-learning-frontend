    ...
    <div className="space-y-6">
      ...
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-gray-600 mt-1">Manage users, roles, and permissions across your platform.</p>
        </div>
      ...
      <Card className="bg-white">
        <CardHeader>
          ...
          <CardDescription>A list of all users in your platform including their role and status.</CardDescription>
        </CardHeader>
        <CardContent>
          <div className="flex items-center space-x-4 mb-6">
            ...
            <DropdownMenu>
              ...
              <DropdownMenuContent className="bg-white">
                <DropdownMenuLabel className="text-gray-600">Filter by Status</DropdownMenuLabel>
                <DropdownMenuSeparator />
                <DropdownMenuItem className="text-gray-600" onClick={() => setSelectedFilter("all")}>All Users</DropdownMenuItem>
                <DropdownMenuItem className="text-gray-600" onClick={() => setSelectedFilter("active")}>Active</DropdownMenuItem>
                <DropdownMenuItem className="text-gray-600" onClick={() => setSelectedFilter("inactive")}>Inactive</DropdownMenuItem>
                <DropdownMenuItem className="text-gray-600" onClick={() => setSelectedFilter("suspended")}>Suspended</DropdownMenuItem>
              </DropdownMenuContent>
            </DropdownMenu>
          </div>
                ...
                <TableRow key={user.id}>
                  ...
                  <TableCell>
                    <div className="text-sm text-gray-600">
                      ...
                      <p className="text-xs text-gray-600">{user.coursesCompleted} completed</p>
                    </div>
                  </TableCell>
                  ...
                  <TableCell className="text-right">
                    <DropdownMenu>
                      ...
                      <DropdownMenuContent align="end" className="bg-white">
                        <DropdownMenuLabel className="text-gray-600">Actions</DropdownMenuLabel>
                        <DropdownMenuSeparator />
